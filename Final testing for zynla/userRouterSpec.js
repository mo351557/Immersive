...
describe('Supertesting for Users.........', () => {
  it('Testing verify(post)', (done) => {
      url
      .post('/verify')
      .send({'email':'zynlatesting1@gmail.com','verifyId':'351557'})
      .expect(200)
      .expect('Content-Type', /json/)
      .end(function(err, res) {
          if (err)
...
describe('Supertesting for Users.........',()=>{
  it('Change password(find)',(done)=>{
    url
    .post('/changePassword')
    .send({ 'email': 'akhileshwar.r1@gmail.com','newPass':'akhil'})
    .expect(200)
    .end(function(err, response){
      if (err) return done(err);
      done();
